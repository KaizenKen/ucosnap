...
if (isset($_POST['insertPhotoBtn'])) {
	...
	$saveImgToDb = insertPhoto($pdo, $imageName, $_SESSION['username'], $description, $photo_id, $album);
...
if (isset($_POST['newAlbumBtn'])) {
	$album_name = $_POST['newAlbumName'];
...
if (isset($_POST['renameAlbumBtn'])) {
	$album_id = $_POST['album_id'];
	$album_name = $_POST['newAlbumName'];

	$editAlbum = editAlbum($pdo, $album_name, $album_id);
